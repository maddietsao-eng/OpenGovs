                ...
                {COUNTRIES.map((country) => (
                    <button
                                ...
                                <div className="flex items-center gap-2 mb-1.5">
                                              <span className="text-xl">{country.flag}</span>span>
                                              <span className={`font-semibold text-sm ${country.accent}`}>{country.name}</span>span>
                                </div>div>
                        ...
                        <div className="md:max-w-5xl mx-auto px-3 md:px-6 py-2.5 flex justify-between items-center">
                                  <a href="/" className="flex items-center gap-2">
                                              <div className="w-7 h-7 bg-navy rounded-md flex items-center justify-center">
                                                            <span className="text-white font-bold text-sm">OG</span>span>
                                              </div>div>
                                              <span className="font-semibold text-navy text-lg">OpenGovs</span>span>
                                  </a>a>
                                  <div className="flex items-center gap-3">
                                              <span className="hidden md:flex items-center gap-1.5 text-xs text-gray-500">
                                                            🇦🇺 🇫🇷 🇯🇵 🇵🇭 🇹🇼 🇺🇸
                                                            <span className="font-medium text-gray-700">6 countries</span>span>
                                              </span>span>
                                              <a
                                                            ...
                                                            >
                                                            <span className="underline">Source Documents</span>span>
                                                ...
                                                <div className="text-center pb-4 md:pb-6 pt-6">
                                                              <div className="flex items-center justify-center gap-3 mb-4">
                                                                              <div className="w-12 h-12 bg-navy rounded-xl flex items-center justify-center shadow-lg">
                                                                                                <span className="text-white font-bold text-xl">OG</span>span>
                                                                              </div>div>
                                                              </div>div>
                                                              <h1 className="text-3xl md:text-5xl font-bold text-navy mb-3">OpenGovs</h1>h1>
                                                              ...
                                                              <p className="text-sm text-gray-400 mb-4">
                                                                              🇦🇺 Australia &nbsp;·&nbsp; 🇫🇷 France &nbsp;·&nbsp; 🇯🇵 Japan &nbsp;·&nbsp; 🇵🇭 Philippines &nbsp;·&nbsp; 🇹🇼 Taiwan &nbsp;·&nbsp; 🇺🇸 USA
                                                              </p>p>
                                                </div>div>
                                  )}
                                                              ...
                                                              <div className="text-center pt-4 md:pt-6 pb-8 text-gray-500 text-xs md:text-sm">
                                                                {isLoading ? (
                                                                    <div className="flex items-center justify-center gap-2">
                                                                                        <span>Searching budget data</span>span>
                                                                    ...
                                                                    <span>
                                                                      ...
                                                                      {" + "}
                                                                                        <span className="font-medium">OpenGovs</span>span>
                                                                      {" · "}
                                                                                        <span>23 documents across 6 countries</span>span>
                                                                    </span>span>
                                                                              )}
                                                              </div>div>
                                                </>>
